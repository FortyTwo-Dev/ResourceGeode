...
public class ModConfiguredFeatures {
    public static final DeferredRegister<ConfiguredFeature<?, ?>> CONFIGURED_FEATURES =
            DeferredRegister.create(Registry.CONFIGURED_FEATURE_REGISTRY, ResourceGeode.MOD_ID);

    public static final RegistryObject<ConfiguredFeature<?, ?>> UNIVERSAL_GEODE = CONFIGURED_FEATURES.register("universal_geode",
